 ...
 */
export type updateQaConfigResponse200 = {
  data: ProjectResponse
  status: 200
}

export type updateQaConfigResponse400 = {
  data: void
  status: 400
}

export type updateQaConfigResponse401 = {
  data: void
  status: 401
}

export type updateQaConfigResponse404 = {
  data: void
  status: 404
}

export type updateQaConfigResponseSuccess = (updateQaConfigResponse200) & {
  headers: Headers;
};
export type updateQaConfigResponseError = (updateQaConfigResponse400 | updateQaConfigResponse401 | updateQaConfigResponse404) & {
  headers: Headers;
};

export type updateQaConfigResponse = (updateQaConfigResponseSuccess | updateQaConfigResponseError)

export const getUpdateQaConfigUrl = (id: string,) => {


  

  return `/api/v1/projects/${id}/qa-config`
}

export const updateQaConfig = async (id: string,
    updateQaConfigRequest: UpdateQaConfigRequest, options?: RequestInit): Promise<updateQaConfigResponse> => {
...
export const getUpdateQaConfigMutationOptions = <TError = void,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateQaConfig>>, TError,{id: string;data: UpdateQaConfigRequest}, TContext>, fetch?: RequestInit}
 ...
 * @summary PATCH /api/v1/projects/:id/qa-config
 */
export const useUpdateQaConfig = <TError = void,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateQaConfig>>, TError,{id: string;data: UpdateQaConfigRequest}, TContext>, fetch?: RequestInit}
 , queryClient?: QueryClient): UseMutationResult<
        Awaited<ReturnType<typeof updateQaConfig>>,
        TError,
        {id: string;data: UpdateQaConfigRequest},
        TContext
      > => {
